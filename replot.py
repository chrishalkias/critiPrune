...
make_scaling_plots(results, scaling, output_dir='mnist_figures')

# --- MNIST 28x28 (mnist28_figures) ---
print("\n=== MNIST 28×28 ===")
from mnist28_scaling import make_plots as make_plots_28  # noqa: E402
results28 = fix_accs(load_json('mnist28_figures/mnist28_scaling_results.json'))
scaling28 = load_json('mnist28_figures/mnist28_scaling_laws.json')
make_plots_28(results28, scaling28, 'mnist28_figures')

# --- CIFAR-10 (cifar_figures) ---
print("\n=== CIFAR-10 ===")
from cifar_scaling import make_plots as make_plots_cifar  # noqa: E402
results_c = fix_accs(load_json('cifar_figures/cifar_scaling_results.json'))
scaling_c = load_json('cifar_figures/cifar_scaling_laws.json')
make_plots_cifar(results_c, scaling_c, 'cifar_figures')
...
if os.path.exists('pythia_figures/pythia_results.json'):
    ...
    make_sigmoid_curves_plot(p_results, 'pythia_figures')
    make_k0_scaling_plot(p_results, p_scaling, 'pythia_figures')
