...
make_scaling_plots(results, scaling, output_dir='assets/legacy/mnist')

# --- MNIST 28x28 (assets/legacy/mnist28) ---
print("\n=== MNIST 28×28 ===")
from mnist28_scaling import make_plots as make_plots_28  # noqa: E402
results28 = fix_accs(load_json('assets/legacy/mnist28/mnist28_scaling_results.json'))
scaling28 = load_json('assets/legacy/mnist28/mnist28_scaling_laws.json')
make_plots_28(results28, scaling28, 'assets/legacy/mnist28')

# --- CIFAR-10 (cifar_figures) ---
print("\n=== CIFAR-10 ===")
from cifar_scaling import make_plots as make_plots_cifar  # noqa: E402
results_c = fix_accs(load_json('assets/legacy/cifar/cifar_scaling_results.json'))
scaling_c = load_json('assets/legacy/cifar/cifar_scaling_laws.json')
make_plots_cifar(results_c, scaling_c, 'assets/legacy/cifar')
...
if os.path.exists('pythia_figures/pythia_results.json'):
    ...
    os.makedirs('assets/legacy/pythia', exist_ok=True)
    make_sigmoid_curves_plot(p_results, 'assets/legacy/pythia')
    make_k0_scaling_plot(p_results, p_scaling, 'assets/legacy/pythia')
